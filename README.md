...
The goal is to create a script that will get, compile and install PHP 5.2.9 and a list of desired dependencies.
...
Tested on a 32-bit system with Mac OS X Leopard. I'd imagine some changes would be needed for compiling successfully on a 64-bit system.
